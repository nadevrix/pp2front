...
// Botón hamburguesa + drawer para menú mobile. Se usa en Nav (dashboard) y
// PublicNav (landing). Acepta una lista de links y opcionalmente acciones
// extra (logout, CTA, etc) que se renderizan abajo del drawer.
